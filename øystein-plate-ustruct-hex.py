...
# math eval to modulate the element size using a mathematical function of spatial coordinates
# (quadratic depending on distance to line l)
mesh.field.add("MathEval", 2)
mesh.field.setString(2, "F", "0.8*F1^2 +" + str(lcsmallest))
...
# mesh constraints
# model.mesh.setSizeCallback(3, 1, ll, ll, hh, 0.001)
...
gmsh.write("øystein-ustruct-refined.msh")
